...
#define STRING_CONFIG_H_AUTHOR "(nesifox, EI3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NesiVanli EI3"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 4,98
  #define DEFAULT_bedKd 101,57
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 155 }
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 29       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
